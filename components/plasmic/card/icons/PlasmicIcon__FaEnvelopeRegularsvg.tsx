...
export type FaEnvelopeRegularsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaEnvelopeRegularsvgIcon(props: FaEnvelopeRegularsvgIconProps) {
...
export default FaEnvelopeRegularsvgIcon;
/* prettier-ignore-end */
