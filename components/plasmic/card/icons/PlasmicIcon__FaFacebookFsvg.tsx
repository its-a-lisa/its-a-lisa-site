...
export type FaFacebookFsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaFacebookFsvgIcon(props: FaFacebookFsvgIconProps) {
...
export default FaFacebookFsvgIcon;
/* prettier-ignore-end */
