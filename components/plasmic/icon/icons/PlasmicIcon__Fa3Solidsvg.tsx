...
export type Fa3SolidsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Fa3SolidsvgIcon(props: Fa3SolidsvgIconProps) {
...
export default Fa3SolidsvgIcon;
/* prettier-ignore-end */
