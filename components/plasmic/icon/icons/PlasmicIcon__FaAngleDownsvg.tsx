...
export type FaAngleDownsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaAngleDownsvgIcon(props: FaAngleDownsvgIconProps) {
...
export default FaAngleDownsvgIcon;
/* prettier-ignore-end */
