...
export type FaAngleLeftsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaAngleLeftsvgIcon(props: FaAngleLeftsvgIconProps) {
...
export default FaAngleLeftsvgIcon;
/* prettier-ignore-end */
