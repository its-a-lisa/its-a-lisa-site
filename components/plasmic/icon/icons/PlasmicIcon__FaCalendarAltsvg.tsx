...
export type FaCalendarAltsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaCalendarAltsvgIcon(props: FaCalendarAltsvgIconProps) {
...
export default FaCalendarAltsvgIcon;
/* prettier-ignore-end */
