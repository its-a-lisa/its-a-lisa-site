...
export type FaCompresssvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaCompresssvgIcon(props: FaCompresssvgIconProps) {
...
export default FaCompresssvgIcon;
/* prettier-ignore-end */
