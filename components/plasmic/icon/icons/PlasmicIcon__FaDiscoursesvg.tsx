...
export type FaDiscoursesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaDiscoursesvgIcon(props: FaDiscoursesvgIconProps) {
...
export default FaDiscoursesvgIcon;
/* prettier-ignore-end */
