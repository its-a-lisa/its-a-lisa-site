...
export type FaEllipsisVsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaEllipsisVsvgIcon(props: FaEllipsisVsvgIconProps) {
...
export default FaEllipsisVsvgIcon;
/* prettier-ignore-end */
