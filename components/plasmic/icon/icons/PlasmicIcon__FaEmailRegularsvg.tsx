...
export type FaEmailRegularsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaEmailRegularsvgIcon(props: FaEmailRegularsvgIconProps) {
...
export default FaEmailRegularsvgIcon;
/* prettier-ignore-end */
