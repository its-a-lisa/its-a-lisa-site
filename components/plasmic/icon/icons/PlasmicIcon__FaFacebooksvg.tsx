...
export type FaFacebooksvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaFacebooksvgIcon(props: FaFacebooksvgIconProps) {
...
export default FaFacebooksvgIcon;
/* prettier-ignore-end */
