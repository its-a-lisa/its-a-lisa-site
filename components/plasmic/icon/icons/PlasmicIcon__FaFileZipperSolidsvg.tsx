...
export type FaFileZipperSolidsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaFileZipperSolidsvgIcon(props: FaFileZipperSolidsvgIconProps) {
...
export default FaFileZipperSolidsvgIcon;
/* prettier-ignore-end */
