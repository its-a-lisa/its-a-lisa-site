...
export type FaLockOpensvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaLockOpensvgIcon(props: FaLockOpensvgIconProps) {
...
export default FaLockOpensvgIcon;
/* prettier-ignore-end */
