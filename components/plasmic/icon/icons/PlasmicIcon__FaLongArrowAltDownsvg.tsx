...
export type FaLongArrowAltDownsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaLongArrowAltDownsvgIcon(
  props: FaLongArrowAltDownsvgIconProps
) {
...
export default FaLongArrowAltDownsvgIcon;
/* prettier-ignore-end */
