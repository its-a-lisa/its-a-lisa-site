...
export type FaLongArrowAltUpsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaLongArrowAltUpsvgIcon(props: FaLongArrowAltUpsvgIconProps) {
...
export default FaLongArrowAltUpsvgIcon;
/* prettier-ignore-end */
