...
export type FaMapMarkersvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaMapMarkersvgIcon(props: FaMapMarkersvgIconProps) {
...
export default FaMapMarkersvgIcon;
/* prettier-ignore-end */
