...
export type FaPauseCirclesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaPauseCirclesvgIcon(props: FaPauseCirclesvgIconProps) {
...
export default FaPauseCirclesvgIcon;
/* prettier-ignore-end */
