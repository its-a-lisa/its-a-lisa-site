...
export type FaPlusCirclesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaPlusCirclesvgIcon(props: FaPlusCirclesvgIconProps) {
...
export default FaPlusCirclesvgIcon;
/* prettier-ignore-end */
