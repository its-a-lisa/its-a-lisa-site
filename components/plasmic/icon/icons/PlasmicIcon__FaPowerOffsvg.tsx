...
export type FaPowerOffsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaPowerOffsvgIcon(props: FaPowerOffsvgIconProps) {
...
export default FaPowerOffsvgIcon;
/* prettier-ignore-end */
