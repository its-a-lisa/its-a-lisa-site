...
export type FaQuestionCirclesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaQuestionCirclesvgIcon(props: FaQuestionCirclesvgIconProps) {
...
export default FaQuestionCirclesvgIcon;
/* prettier-ignore-end */
