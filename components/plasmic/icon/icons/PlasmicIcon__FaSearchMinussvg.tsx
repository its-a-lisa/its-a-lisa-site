...
export type FaSearchMinussvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaSearchMinussvgIcon(props: FaSearchMinussvgIconProps) {
...
export default FaSearchMinussvgIcon;
/* prettier-ignore-end */
