...
export type FaSearchPlussvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaSearchPlussvgIcon(props: FaSearchPlussvgIconProps) {
...
export default FaSearchPlussvgIcon;
/* prettier-ignore-end */
