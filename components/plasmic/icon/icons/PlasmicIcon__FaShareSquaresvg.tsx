...
export type FaShareSquaresvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaShareSquaresvgIcon(props: FaShareSquaresvgIconProps) {
...
export default FaShareSquaresvgIcon;
/* prettier-ignore-end */
