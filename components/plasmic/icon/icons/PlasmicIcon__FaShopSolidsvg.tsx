...
export type FaShopSolidsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaShopSolidsvgIcon(props: FaShopSolidsvgIconProps) {
...
export default FaShopSolidsvgIcon;
/* prettier-ignore-end */
