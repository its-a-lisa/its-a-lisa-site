...
export type FaSnapchatsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaSnapchatsvgIcon(props: FaSnapchatsvgIconProps) {
...
export default FaSnapchatsvgIcon;
/* prettier-ignore-end */
