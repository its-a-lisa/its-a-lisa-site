...
export type FaSquareGithubsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaSquareGithubsvgIcon(props: FaSquareGithubsvgIconProps) {
...
export default FaSquareGithubsvgIcon;
/* prettier-ignore-end */
