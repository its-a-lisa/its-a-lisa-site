...
export type FaSquareLastfmsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaSquareLastfmsvgIcon(props: FaSquareLastfmsvgIconProps) {
...
export default FaSquareLastfmsvgIcon;
/* prettier-ignore-end */
