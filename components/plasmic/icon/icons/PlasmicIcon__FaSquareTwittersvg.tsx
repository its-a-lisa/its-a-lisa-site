...
export type FaSquareTwittersvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaSquareTwittersvgIcon(props: FaSquareTwittersvgIconProps) {
...
export default FaSquareTwittersvgIcon;
/* prettier-ignore-end */
