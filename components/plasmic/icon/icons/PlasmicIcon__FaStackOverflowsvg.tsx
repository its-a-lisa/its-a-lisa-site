...
export type FaStackOverflowsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaStackOverflowsvgIcon(props: FaStackOverflowsvgIconProps) {
...
export default FaStackOverflowsvgIcon;
/* prettier-ignore-end */
