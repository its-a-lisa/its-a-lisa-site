...
export type FaStarRegularsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaStarRegularsvgIcon(props: FaStarRegularsvgIconProps) {
...
export default FaStarRegularsvgIcon;
/* prettier-ignore-end */
