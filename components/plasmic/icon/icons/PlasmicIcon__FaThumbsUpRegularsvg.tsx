...
export type FaThumbsUpRegularsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaThumbsUpRegularsvgIcon(props: FaThumbsUpRegularsvgIconProps) {
...
export default FaThumbsUpRegularsvgIcon;
/* prettier-ignore-end */
