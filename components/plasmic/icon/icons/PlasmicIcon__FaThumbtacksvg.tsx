...
export type FaThumbtacksvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaThumbtacksvgIcon(props: FaThumbtacksvgIconProps) {
...
export default FaThumbtacksvgIcon;
/* prettier-ignore-end */
