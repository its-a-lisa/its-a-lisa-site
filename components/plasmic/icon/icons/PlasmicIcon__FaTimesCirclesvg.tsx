...
export type FaTimesCirclesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaTimesCirclesvgIcon(props: FaTimesCirclesvgIconProps) {
...
export default FaTimesCirclesvgIcon;
/* prettier-ignore-end */
