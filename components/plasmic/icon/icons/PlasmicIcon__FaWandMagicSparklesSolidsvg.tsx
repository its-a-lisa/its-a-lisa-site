...
export type FaWandMagicSparklesSolidsvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function FaWandMagicSparklesSolidsvgIcon(
  props: FaWandMagicSparklesSolidsvgIconProps
) {
...
export default FaWandMagicSparklesSolidsvgIcon;
/* prettier-ignore-end */
