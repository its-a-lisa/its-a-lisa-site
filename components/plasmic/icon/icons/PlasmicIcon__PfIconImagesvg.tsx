...
export type PfIconImagesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PfIconImagesvgIcon(props: PfIconImagesvgIconProps) {
...
export default PfIconImagesvgIcon;
/* prettier-ignore-end */
