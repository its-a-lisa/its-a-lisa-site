...
export type PfIconRoutesvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PfIconRoutesvgIcon(props: PfIconRoutesvgIconProps) {
...
export default PfIconRoutesvgIcon;
/* prettier-ignore-end */
