...
import sty from "./PlasmicCompButton.module.css"; // plasmic-import: hOjYiBDjTmoS/css
...
export type PlasmicCompButton__VariantMembers = {
...
export type PlasmicCompButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicCompButton__VariantsArgs;
export const PlasmicCompButton__VariantProps = new Array<VariantPropType>(
  "isDisabled",
  "shape",
  "size",
  "showStartIcon",
...
export type PlasmicCompButton__ArgsType = {
...
type ArgPropType = keyof PlasmicCompButton__ArgsType;
export const PlasmicCompButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicCompButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultCompButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"sm" | "md" | "lg" | "xl">;
...
function PlasmicCompButton__RenderFunc(props: {
  variants: PlasmicCompButton__VariantsArgs;
  args: PlasmicCompButton__ArgsType;
  overrides: PlasmicCompButton__OverridesType;
  forNode?: string;
}) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaChecksvgIcon
              className={classNames(projectcss.all, sty.svg__rRo5T)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaArrowRightsvgIcon
              className={classNames(projectcss.all, sty.svg___6UGl6)}
              role={"img"}
            />
          ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicCompButton>(
    PlasmicCompButton,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCompButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicCompButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCompButton__ArgProps,
          internalVariantPropNames: PlasmicCompButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCompButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCompButton";
  } else {
    func.displayName = `PlasmicCompButton.${nodeName}`;
  }
  return func;
}

export const PlasmicCompButton = Object.assign(
  // Top-level PlasmicCompButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCompButton
    internalVariantProps: PlasmicCompButton__VariantProps,
    internalArgProps: PlasmicCompButton__ArgProps,

    useBehavior
  }
);

export default PlasmicCompButton;
/* prettier-ignore-end */
