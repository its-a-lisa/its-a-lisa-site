...
import sty from "./PlasmicCompSeparator.module.css"; // plasmic-import: qGPOjREOYOzh/css

createPlasmicElementProxy;

export type PlasmicCompSeparator__VariantMembers = {
  orientationShift: "orientationShift";
  length: "full" | "_75" | "_50" | "_25";
  emphasis: "minimal" | "subtle" | "moderate" | "bold" | "contrast";
};
export type PlasmicCompSeparator__VariantsArgs = {
...
type VariantPropType = keyof PlasmicCompSeparator__VariantsArgs;
export const PlasmicCompSeparator__VariantProps = new Array<VariantPropType>(
  "orientationShift",
  "length",
  "emphasis"
);

export type PlasmicCompSeparator__ArgsType = {};
type ArgPropType = keyof PlasmicCompSeparator__ArgsType;
export const PlasmicCompSeparator__ArgProps = new Array<ArgPropType>();

export type PlasmicCompSeparator__OverridesType = {
  root?: Flex__<"div">;
};

export interface DefaultCompSeparatorProps {
  orientationShift?: SingleBooleanChoiceArg<"orientationShift">;
  length?: SingleChoiceArg<"full" | "_75" | "_50" | "_25">;
  emphasis?: SingleChoiceArg<
    "minimal" | "subtle" | "moderate" | "bold" | "contrast"
...
function PlasmicCompSeparator__RenderFunc(props: {
  variants: PlasmicCompSeparator__VariantsArgs;
  args: PlasmicCompSeparator__ArgsType;
  overrides: PlasmicCompSeparator__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__wgkfH, {
          [sty.freeBoxorientationShift__wgkfHssQi3]: hasVariant(
            $state,
            "orientationShift",
            "orientationShift"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___8Q9PR, {
            [sty.freeBoxemphasis_bold___8Q9PRyCcP0]: hasVariant(
              $state,
              "emphasis",
              "bold"
            ),
            [sty.freeBoxemphasis_contrast___8Q9PRwXTry]: hasVariant(
              $state,
              "emphasis",
              "contrast"
            ),
            [sty.freeBoxemphasis_minimal___8Q9PRuxa4V]: hasVariant(
              $state,
              "emphasis",
              "minimal"
            ),
            [sty.freeBoxemphasis_moderate___8Q9PRniMB]: hasVariant(
              $state,
              "emphasis",
              "moderate"
            ),
            [sty.freeBoxemphasis_subtle___8Q9PRwgmCx]: hasVariant(
              $state,
              "emphasis",
              "subtle"
            ),
            [sty.freeBoxlength__25___8Q9PRoPyU7]: hasVariant(
              $state,
              "length",
              "_25"
            ),
            [sty.freeBoxlength__50___8Q9PR7Ima8]: hasVariant(
              $state,
              "length",
              "_50"
            ),
            [sty.freeBoxlength__75___8Q9PRshMgk]: hasVariant(
              $state,
              "length",
              "_75"
            ),
            [sty.freeBoxorientationShift___8Q9PRssQi3]: hasVariant(
              $state,
              "orientationShift",
              "orientationShift"
            )
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompSeparator__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCompSeparator__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicCompSeparator__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCompSeparator__ArgProps,
          internalVariantPropNames: PlasmicCompSeparator__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCompSeparator__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCompSeparator";
  } else {
    func.displayName = `PlasmicCompSeparator.${nodeName}`;
  }
  return func;
}

export const PlasmicCompSeparator = Object.assign(
  // Top-level PlasmicCompSeparator renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements

    // Metadata about props expected for PlasmicCompSeparator
    internalVariantProps: PlasmicCompSeparator__VariantProps,
    internalArgProps: PlasmicCompSeparator__ArgProps
  }
);

export default PlasmicCompSeparator;
/* prettier-ignore-end */
