...
import sty from "./PlasmicPatternFeature.module.css"; // plasmic-import: DN4o2sVmLikj/css

createPlasmicElementProxy;

export type PlasmicPatternFeature__VariantMembers = {
  noImage: "noImage";
};
export type PlasmicPatternFeature__VariantsArgs = {
  noImage?: SingleBooleanChoiceArg<"noImage">;
};
type VariantPropType = keyof PlasmicPatternFeature__VariantsArgs;
export const PlasmicPatternFeature__VariantProps = new Array<VariantPropType>(
  "noImage"
);

export type PlasmicPatternFeature__ArgsType = {
  children?: React.ReactNode;
  slot?: React.ReactNode;
};
type ArgPropType = keyof PlasmicPatternFeature__ArgsType;
export const PlasmicPatternFeature__ArgProps = new Array<ArgPropType>(
  "children",
  "slot"
);

export type PlasmicPatternFeature__OverridesType = {
  root?: Flex__<"div">;
};

export interface DefaultPatternFeatureProps {
  children?: React.ReactNode;
  slot?: React.ReactNode;
  noImage?: SingleBooleanChoiceArg<"noImage">;
  className?: string;
...
function PlasmicPatternFeature__RenderFunc(props: {
  variants: PlasmicPatternFeature__VariantsArgs;
  args: PlasmicPatternFeature__ArgsType;
  overrides: PlasmicPatternFeature__OverridesType;
  forNode?: string;
}) {
    ...
    () => [
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.noImage
      }
    ],
    [$props, $ctx, $refs]
  );
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootnoImage]: hasVariant($state, "noImage", "noImage")
        }
      )}
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lM4CH, {
          [sty.freeBoxnoImage__lM4CHbBxWq]: hasVariant(
            $state,
            "noImage",
            "noImage"
          )
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__mAlLq)}
              displayHeight={"auto"}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__qfVh0)}>
        <div className={classNames(projectcss.all, sty.freeBox__t97DH)}>
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <div
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicPatternFeature__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicPatternFeature__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicPatternFeature__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPatternFeature__ArgProps,
          internalVariantPropNames: PlasmicPatternFeature__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPatternFeature__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPatternFeature";
  } else {
    func.displayName = `PlasmicPatternFeature.${nodeName}`;
  }
  return func;
}

export const PlasmicPatternFeature = Object.assign(
  // Top-level PlasmicPatternFeature renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements

    // Metadata about props expected for PlasmicPatternFeature
    internalVariantProps: PlasmicPatternFeature__VariantProps,
    internalArgProps: PlasmicPatternFeature__ArgProps
  }
);

export default PlasmicPatternFeature;
/* prettier-ignore-end */
